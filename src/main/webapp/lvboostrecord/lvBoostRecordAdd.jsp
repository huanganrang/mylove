...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/lvBoostRecordController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="activtyId" type="text" class="easyui-validatebox span2" data-options="required:true"/>
					</td>							
				</tr>	
				<tr>	
				...
				<tr>	
					...
					<td>
					<input class="span2" name="boostTime" type="text" onclick="WdatePicker({dateFmt:'<%=TlvBoostRecord.FORMAT_BOOST_TIME%>'})"  maxlength="0" class="required " />
					</td>							
					<th><%=TlvBoostRecord.ALIAS_OPEN_TIME%></th>	
					<td>
					<input class="span2" name="openTime" type="text" onclick="WdatePicker({dateFmt:'<%=TlvBoostRecord.FORMAT_OPEN_TIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
				<tr>	
					<th><%=TlvBoostRecord.ALIAS_OPEN_STATUS%></th>	
					<td>
					<input class="span2" name="openStatus" type="text" class="span2"/>
					</td>							
				</tr>	
			</table>		
		</form>
