...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/lvAddressController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="consignee" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					...
					<td>
					<input class="span2" name="province" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					...
					<td>
					<input class="span2" name="district" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					...
					<td>
					<input class="span2" name="createTime" type="text" onclick="WdatePicker({dateFmt:'<%=TlvAddress.FORMAT_CREATE_TIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
				<tr>	
					<th><%=TlvAddress.ALIAS_UPDATE_TIME%></th>	
					<td>
					<input class="span2" name="updateTime" type="text" onclick="WdatePicker({dateFmt:'<%=TlvAddress.FORMAT_UPDATE_TIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
