...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/userMessageController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td>
					<input class="span2" name="umType" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					<th><%=TuserMessage.ALIAS_UM_MESSAGE%></th>	
					<td>
					<input class="span2" name="umMessage" type="text" class="span2"/>
					</td>							
					<th><%=TuserMessage.ALIAS_UM_REMARK%></th>	
					<td>
					<input class="span2" name="umRemark" type="text" class="span2"/>
					</td>							
				</tr>	
				<tr>	
					...
					<td>
					<input class="span2" name="updatePerson" type="text" class="span2"/>
					</td>							
				</tr>	
			</table>		
		</form>
