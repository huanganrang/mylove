...
<script type="text/javascript">
	$(function() {
	 parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/bshootCollectController/add',
			onSubmit : function() {
		...
		<form id="form" method="post">		
			...
			<table class="table table-hover table-condensed">
				...
				<tr>	
					...
					<td>
					<input class="span2" name="collectDatetime" type="text" onclick="WdatePicker({dateFmt:'<%=TbshootCollect.FORMAT_COLLECT_DATETIME%>'})"  maxlength="0" class="" />
					</td>							
				</tr>	
			</table>		
		</form>
