...
<body >
	<div id="index_people_center_tabs" class="easyui-tabs" data-options="fit:true">
		...
		<div title="开始挖宝" data-options="href:'../api_doing.jsp'"
			style="padding: 1px"></div>
		<div title="活动商品详情" data-options="href:'../api_doing.jsp'"
			style="padding: 1px"></div>
		<div title="助力信息" data-options="href:'../api_doing.jsp'"
			style="padding: 1px"></div>
		<div title="挖宝纪录" data-options="href:'../api_doing.jsp'"
			style="padding: 1px"></div>
		<div title="收货地址（查）" data-options="href:'../api_doing.jsp'"
			style="padding: 1px"></div>
		<div title="收货地址（改）" data-options="href:'../api_doing.jsp'"
			style="padding: 1px"></div>	
	</div>
</body>
</html>