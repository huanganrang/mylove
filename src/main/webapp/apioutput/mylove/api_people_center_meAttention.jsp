	...
	$(function() {
		...
		$('#fromFollowPage_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#fromFollowPage_result").text(result);
			}
		});
	});
</script>
			...
			<form id="fromFollowPage_Form">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						...
						<input type="button"
							value="提交" onclick="javascript:$('#fromFollowPage_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
				<div id="fromFollowPage_result">
				</div>
			<div>
				结果说明：1、json格式<br/>
